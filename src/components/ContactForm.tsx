    ...
    <form onSubmit={handleSubmit} className="space-y-6 bg-card rounded-xl p-8 shadow-soft">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Input
            ...
            className="border-ocean-foam focus:border-gold"
        ...
        <div className="space-y-2">
          <Label htmlFor="email" className="text-marine-blue font-medium">
            Email Address *
          </Label>
          <Input
            id="email"
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-3 py-2 border border-ocean-foam rounded-md focus:border-gold focus:outline-none focus:ring-2 focus:ring-gold/20"
          >
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          onChange={handleChange}
          className="border-ocean-foam focus:border-gold min-h-[100px]"
