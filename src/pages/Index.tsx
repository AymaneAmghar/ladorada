...
const Index = () => {
  ...
  const galleryImages = [restaurantInterior, seaBream, seafoodPaella, calamariChermoula, fishTagine];
  const menuItems = [{
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-pearl-white px-4 max-w-4xl mx-auto">
          <img alt="La Dorada Logo" className="h-32 lg:h-40 mx-auto mb-8" src="/lovable-uploads/853695f6-7e21-4903-9916-d54c687f84a8.png" />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <img src={restaurantInterior} alt="La Dorada Restaurant Interior" className="rounded-2xl shadow-elegant" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="menu" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {menuItems.map((item, index) => <Card key={index} className="group hover:shadow-elegant transition-all duration-300 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-elegant">
              <img src={galleryImages[currentImageIndex]} alt="Gallery Image" className="w-full h-full object-cover transition-opacity duration-500" />
            </div>
            
            <div className="flex justify-center mt-6 space-x-2">
              {galleryImages.map((_, index) => <button key={index} onClick={() => setCurrentImageIndex(index)} className={`w-3 h-3 rounded-full transition-colors duration-300 ${index === currentImageIndex ? 'bg-gold' : 'bg-gold/30'}`} />)}
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-coastal">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => <Card key={index} className="bg-pearl-white shadow-soft hover:shadow-elegant transition-shadow duration-300">
                <CardContent className="p-8">
                  <div className="flex items-center mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => <Star key={i} className="h-5 w-5 text-gold fill-current" />)}
                  </div>
